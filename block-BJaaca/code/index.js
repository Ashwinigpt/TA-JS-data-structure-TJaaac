...
//  - Change the method `greet` to new alert `She is [NAME HERE] and her title is [TITLE HERE]`.
...
character.changeIsAdult = character.isAdult != character.isAdult ? true : false;
